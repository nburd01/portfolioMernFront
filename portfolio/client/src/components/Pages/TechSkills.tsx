...
export const TechSkills = () => {
  ...
  <section className='container mx-auto px-4 h-2/3 ' id='TechSkills'>
    ...
    <div className='inline-block sm:place-items-center sm:grid grid-cols-2 grid-flow-row gap-4 hover:duration-300"'>

        <div className="w-2/3 m-10 rounded overflow-hidden shadow-lg">
          <div className="px-6 py-4 bg-beige hover:bg-light_purple hover:duration-300">
