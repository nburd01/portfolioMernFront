...
export const LandingPage = () => {
  return (
    <div className='h-screen flex bg-beige justify-center items-center'>
      ...
      {/* RIGHT */}
        <div className='hidden lg:flex relative inset-0 w-6/12 h-auto justify-center items-center '>
        <div className='flex w-2/4 h-2/4 bg-light_purple rounded-full justify-center items-center absolute left-12 shadow-lg'/>
          <div className='flex w-2/4 h-2/4 bg-main_purple rounded-full justify-center items-center absolute top-12 shadow-lg'/>
          <div className='flex w-2/4 h-2/4 bg-light_purple rounded-full justify-center items-center absolute right-12 shadow-lg'/>
